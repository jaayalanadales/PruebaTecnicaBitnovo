...
namespace PruebaTecnicaBitnovo
{
    public class SwaggerConfig
    {
        ...
        {
            return Path.Combine(System.Web.HttpRuntime.AppDomainAppPath, "bin", "PruebaTecnicaBitnovo.xml");
        }
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                ...
                .EnableSwagger(c =>
                {
                    ...
                    c.SingleApiVersion("v1", "Usuarios Web API");
